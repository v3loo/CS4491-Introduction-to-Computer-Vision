...
std1 = img1_green.std()
print('4a) img1_green: min=%d, max=%d, mean=%f std=%f' %(min1,max1,mean1,std1))

#4b
img1_green_normed = img1_green.copy()
img1_green_normed = cv2.add(cv2.multiply(cv2.divide(cv2.subtract(img1_green_normed, mean1), std1), 10), mean1)
